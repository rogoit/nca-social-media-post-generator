export const GLOBAL_PROMPT_HELPERS = {
  LANGUAGE: `SPRACHE: Alle Ausgaben MUESSEN auf Deutsch sein — das korrigierte Transkript, die Keywords, der Titel, die Beschreibung und jeder Post. Schreibe IMMER auf Deutsch, auch wenn das Originaltranskript englische Wörter, Phrasen oder ganze Saetze enthaelt. Marken und Begriffe aus dem Brandnames-Hinweis behalten ihre kanonische Schreibweise, aber der gesamte Text ist deutsch. Niemals englisch antworten.`,

  HASHTAG_RULE_SOCIAL: `Hashtags: GENAU 5 am Ende. Zuerst 3 kompakte themenspezifische Tags, abgeleitet aus den Keywords (1-2 Wörter, kleingeschrieben). KEINE generischen Massen-Hashtags — verboten sind #coding, #ai, #ki, #programming, #developer, #tech und ähnliche sättigte Tags. Dann #vibecoding. Ganz am Schluss #nevercodealone.`,

  HASHTAG_RULE_YOUTUBE: `Hashtags in der Beschreibung: GENAU 2 am Ende, abgeleitet aus den Keywords (1-2 Wörter, kleingeschrieben). Nur spezifische, findbare Tags — KEINE generischen Massen-Hashtags (kein #coding, #ai, #ki, #programming, #developer, #tech). Kein Brand-Tag auf YouTube.`,

  BRAND_NAMES: `Achte auf die richtige Schreibweise dieser Marken und Begriffe: Never Code Alone (nicht nevercodealone, never code alone oder NeverCodeAlone), Roland Golla (nicht Roland Goler oder andere Varianten), roland@nevercodealone.de (nicht Roland@codealone.de oder andere Varianten), AI Nights (nicht AI Knights, AI Lights oder andere Varianten), Pimcore (nicht PimCore oder pimcore), TYPO3 (nicht Typo3 oder typo3), CypressIO (nicht Cypress.io oder cypress), JavaScript (nicht Javascript oder javascript), ChatGPT (nicht Chat-GPT oder chatgpt), OpenAI (nicht Open AI oder openai), React (nicht ReactJS oder react), Node.js (nicht NodeJS oder nodejs), Vue.js (nicht VueJS oder vuejs), TypeScript (nicht Typescript oder typescript), PHP (nicht php, Php, prp oder PRP), PHPUnit (nicht PhpUnit oder phpunit), PHPStan (nicht Phpstan oder php-stan), RectorPHP (nicht Rector oder rector-php), Vitest (nicht vitest oder vi-test), Make.com (nicht Make, Make.io oder make.com), Claude Code (nicht claude code oder ClaudeCode), Kimi 3 (nicht Kimi3, Kimi III, kimi 3, Kimmy 3, Key Me 3 oder andere Varianten), Vibe Coding (nicht vibe coding, VibeCoding, White Coding, white coding, Weiß Coding, weiß coding, Weib Coding, weib coding oder andere Varianten), GitHub (nicht Github oder github), Docker (nicht docker), Kubernetes (nicht kubernetes), AWS (nicht aws), PostgreSQL (nicht postgres oder postgresql), Astro (nicht astro), Anthropic (nicht anthropic), Google Gemini (nicht google gemini oder Gemini), VS Code (nicht vscode oder VSCode), Laravel (nicht laravel), Symfony (nicht Symphony oder symfony), Next.js (nicht NextJS oder nextjs), WordPress (nicht wordpress oder Wordpress), Moltbot (nicht Maltbot, maltbot oder andere Varianten), Moltbook (nicht Maltbook, maltbook oder andere Varianten), Lovable (nicht Loverable, lovable, Laravel oder andere Varianten), OpenCode (nicht open code, opencode, Open Code, VS Code, Cursor oder andere Varianten).`,

  AVOID_EXAGGERATION: `KEINE übertriebenen Wörter wie "ultimativ", "revolutionär", "Revolution", "revolutionieren", "revolutioniert", "transformiert", "Transformation", "Game-Changer", "game-changing", "Disruption", "disruptiv", "Paradigmenwechsel", "Meilenstein" (figurativ), "bahnbrechend", "zukunftsweisend", "das ändert alles", "stört die Branche" - halte es sachlich und präzise.`,
...
- KEINE KI-Marker-Vokabeln (Humanizer Pattern 64): Verbiete "beleuchten", "eintauchen", "unterstreichen", "aufzeigen", "entfesseln", "prägen" (figurativ), "spannend", "entscheidend", "maßgeblich", "nahtlos", "vielschichtig", "facettenreich", "dynamisch", "ganzheitlich", "maßgeschneidert", "essenziell", "lebendig" (für Abstrakta), "die digitale Landschaft", "das Zusammenspiel", "die Reise" (figurativ), "das Spannungsfeld". Ab 3+ dieser Marker im selben Text ist es ein Cluster-Tell und MUSS überarbeitet werden.
- KEINE Fake-Analyse-Anhänge (Humanizer Pattern 66): Verbiete Relativsätze wie "was X unterstreicht", "was X belegt", "was X verdeutlicht", "was X bestätigt", "was X beweist", sowie "und zeigt/verdeutlicht damit, dass ...", "und macht deutlich, wie wichtig ...", "und unterstreicht die Bedeutung von ...". Fällt der Relativsatz weg, darf keine Information verloren gehen.
